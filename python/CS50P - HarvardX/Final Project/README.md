...
### Texas Hold'em as a compelling project — user experience perspective
...
> WHEREAS, A true phenomenon of our time, Texas Hold'em has taken the world by storm, captivating countless card enthusiasts with its deceptively simple format ... WHEREAS, It is said that Texas Hold'em **takes a minute to learn and a lifetime to master**, and this telling statement **underscores the high level of skill necessary to win consistently** — [Texas State Legislature describing Texas Hold'em](https://capitol.texas.gov/tlodocs/80R/billtext/html/HR00339_I.htm)

### Texas Hold'em as a compelling project — software perspective

This python project is a small but highly customizable front end for a **JavaScript project** I created several years ago. It puts to use many of the lessons taught in CS50P, including text replacement, libraries, user input, etc. It demonstrates reuse in more than one sense. Python libraries such as **JS2PY** are themselves tools, but in this case these tools extend this program's abilities into other languages, which makes it possible to reuse even *more* libraries.
...
*This game collects no data that is persisted (beyond the scope of the game), analyzed, or otherwise observed by the game's author.* 😇